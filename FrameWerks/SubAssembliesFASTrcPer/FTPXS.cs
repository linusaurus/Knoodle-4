...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXS : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            part = new Part(3444, "BladePX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
            ...
            part = new Part(3444, "BladePS", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PS", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + doorGap);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
