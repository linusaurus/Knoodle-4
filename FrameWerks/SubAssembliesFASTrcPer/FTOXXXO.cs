    ...
    class FTOXXXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_OX", this, 1, (trackHelper.DoorPanelWidth * 2) - stileWidth + jambFinwall);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_OXX", this, 1, (trackHelper.DoorPanelWidth * 3) - (stileWidth * 2) + jambFinwall);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_OXXXX", this, 1, (trackHelper.DoorPanelWidth * 5) + adjOdoor + bladeAdd * 2 - stileWidth * 4 + jambFinwall + bladeAdd);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
