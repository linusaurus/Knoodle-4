    ...
    class FTPXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PX", this, 1, (trackHelper.DoorPanelWidth * 2));
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth + bladeAdd);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
