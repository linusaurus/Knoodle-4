    ...
    public class CaseUnit2x3LHR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                part = new Part(4588, "MuntVert", this, 1, (m_subAssemblyHieght - MuntGapX2) / 3.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "?_Ends";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5124, "AlumGlsStpVert", this, 1, m_subAssemblyHieght - gstopReduce2X);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5124, "AlumGlsStpTopBot", this, 1, m_subAssemblyWidth - gstopReduce2X);
                part.PartGroupType = "StopAlum-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
